...
pub enum OutboundProxyProtocol {
    ...
    #[serde(rename = "vmess")]
    Vmess(OutboundVmess),
    #[serde(rename = "vless-custom")]
    VlessCustom(OutboundVlessCustom),
...
impl OutboundProxyProtocol {
    fn name(&self) -> &str {
        match &self {
            ...
            OutboundProxyProtocol::VlessCustom(vless) => &vless.common_opts.name,
...
impl Display for OutboundProxyProtocol {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            OutboundProxyProtocol::VlessCustom(_) => write!(f, "Vless Custom"),
